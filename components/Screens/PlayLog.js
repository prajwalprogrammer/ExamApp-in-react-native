...
export default class Quiz extends Component {
  ...
  render() {
    ...
    return (
      <View style={{height:height-300,width:width-20, backgroundColor: "#F5FCFF", paddingTop: 30,alignSelf:'center',justifyContent:'center',paddingVertical:'20%',marginTop:'30%',borderRadius:20 }}>
